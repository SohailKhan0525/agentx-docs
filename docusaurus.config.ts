...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {title:'AgentX',logo:{alt:'AgentX Logo',src:'img/logo.png'},items:[
      {type:'docSidebar',sidebarId:'docsSidebar',position:'left',label:'Docs'},
      {href:'https://npmjs.com/package/@agent-qofeno/agentx-cli',label:'npm',position:'right'},
      {href:'https://github.com/SohailKhan0525/agentx-cli',label:'GitHub',position:'right'},
    ]},
    footer: {style:'dark',links:[
      {title:'Docs',items:[{label:'Getting Started',to:'/docs/intro'},{label:'Installation',to:'/docs/installation'},{label:'Providers',to:'/docs/providers'},{label:'Local Models',to:'/docs/local-models'}]},
      {title:'Install',items:[{label:'npm',href:'https://npmjs.com/package/@agent-qofeno/agentx-cli'},{label:'JSR',href:'https://jsr.io/@agent-qofeno/agentx-cli'},{label:'Homebrew',href:'https://github.com/SohailKhan0525/homebrew-agentx'}]},
      {title:'Community',items:[{label:'GitHub',href:'https://github.com/SohailKhan0525/agentx-cli'},{label:'Issues',href:'https://github.com/SohailKhan0525/agentx-cli/issues'}]},
